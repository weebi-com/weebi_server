...
class TicketServiceClient extends $grpc.Client {
  static final _$readAll = $grpc.ClientMethod<$15.Counterfoil, $16.TicketsResponse>(
      '/weebi.ticket.service.TicketService/readAll',
      ($15.Counterfoil value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $16.TicketsResponse.fromBuffer(value));
  static final _$readOne = $grpc.ClientMethod<$16.FindTicketRequest, $15.TicketPb>(
  ...
  $grpc.ResponseFuture<$16.TicketsResponse> readAll($15.Counterfoil request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$readAll, request, options: options);
  }

  $grpc.ResponseFuture<$15.TicketPb> readOne($16.FindTicketRequest request, {$grpc.CallOptions? options}) {
...
abstract class TicketServiceBase extends $grpc.Service {
  ...
  TicketServiceBase() {
    $addMethod($grpc.ServiceMethod<$15.Counterfoil, $16.TicketsResponse>(
        'readAll',
        readAll_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $15.Counterfoil.fromBuffer(value),
        ($16.TicketsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$16.FindTicketRequest, $15.TicketPb>(
        'readOne',
        readOne_Pre,
        false,
        false,
  ...
  $async.Future<$16.TicketsResponse> readAll_Pre($grpc.ServiceCall call, $async.Future<$15.Counterfoil> request) async {
    return readAll(call, await request);
  }

  $async.Future<$15.TicketPb> readOne_Pre($grpc.ServiceCall call, $async.Future<$16.FindTicketRequest> request) async {
  ...
  $async.Future<$16.TicketsResponse> readAll($grpc.ServiceCall call, $15.Counterfoil request);
  $async.Future<$15.TicketPb> readOne($grpc.ServiceCall call, $16.FindTicketRequest request);
