...
import 'ticket_type.pbenum.dart' as $26;
...
class TicketPb extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TicketPb', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.ticket'), createEmptyInstance: create)
    ...
    ..e<$26.TicketTypePb>(7, _omitFieldNames ? '' : 'ticketType', $pb.PbFieldType.OE, protoName: 'ticketType', defaultOrMaker: $26.TicketTypePb.unknown, valueOf: $26.TicketTypePb.valueOf, enumValues: $26.TicketTypePb.values)
  ...
  @$pb.TagNumber(7)
  $26.TicketTypePb get ticketType => $_getN(6);
  @$pb.TagNumber(7)
  set ticketType($26.TicketTypePb v) { setField(7, v); }
  @$pb.TagNumber(7)
