...
@$core.Deprecated('Use boutiqueCreateRequestDescriptor instead')
const BoutiqueCreateRequest$json = {
  '1': 'BoutiqueCreateRequest',
  '2': [
...
/// Descriptor for `BoutiqueCreateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List boutiqueCreateRequestDescriptor = $convert.base64Decode(
    'ChVCb3V0aXF1ZUNyZWF0ZVJlcXVlc3QSGAoHY2hhaW5JZBgBIAEoCVIHY2hhaW5JZBI2Cghib3'
    'V0aXF1ZRgCIAEoCzIaLndlZWJpLmJvdXRpcXVlLkJvdXRpcXVlUGJSCGJvdXRpcXVl');
...
final $typed_data.Uint8List boutiqueRequestDescriptor = $convert.base64Decode(
    'Cg9Cb3V0aXF1ZVJlcXVlc3QSGAoHY2hhaW5JZBgBIAEoCVIHY2hhaW5JZBIeCgpib3V0aXF1ZU'
    'lkGAIgASgJUgpib3V0aXF1ZUlk');

@$core.Deprecated('Use boutiqueUpdateRequestDescriptor instead')
const BoutiqueUpdateRequest$json = {
  '1': 'BoutiqueUpdateRequest',
  '2': [
    {'1': 'chainId', '3': 1, '4': 1, '5': 9, '10': 'chainId'},
    {'1': 'boutiqueId', '3': 2, '4': 1, '5': 9, '10': 'boutiqueId'},
    {'1': 'boutique', '3': 3, '4': 1, '5': 11, '6': '.weebi.boutique.BoutiquePb', '10': 'boutique'},
  ],
};

/// Descriptor for `BoutiqueUpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List boutiqueUpdateRequestDescriptor = $convert.base64Decode(
    'ChVCb3V0aXF1ZVVwZGF0ZVJlcXVlc3QSGAoHY2hhaW5JZBgBIAEoCVIHY2hhaW5JZBIeCgpib3'
    'V0aXF1ZUlkGAIgASgJUgpib3V0aXF1ZUlkEjYKCGJvdXRpcXVlGAMgASgLMhoud2VlYmkuYm91'
    'dGlxdWUuQm91dGlxdWVQYlIIYm91dGlxdWU=');
