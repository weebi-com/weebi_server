...
class UserPermissions extends $pb.GeneratedMessage {
  factory UserPermissions({
    ...
    if (isFirmCreator != null) result.isFirmCreator = isFirmCreator;
    if (hasClosedYears != null) result.hasClosedYears = hasClosedYears;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(16, _omitFieldNames ? '' : 'hasClosedYears')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UserPermissions clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(15)
  set isFirmCreator($core.bool value) => $_setBool(13, value);
  @$pb.TagNumber(15)
  $core.bool hasIsFirmCreator() => $_has(13);
  @$pb.TagNumber(15)
  void clearIsFirmCreator() => $_clearField(15);

  @$pb.TagNumber(16)
  $core.bool get hasClosedYears => $_getBF(14);
  @$pb.TagNumber(16)
  set hasClosedYears($core.bool value) => $_setBool(14, value);
  @$pb.TagNumber(16)
  $core.bool hasHasClosedYears() => $_has(14);
  @$pb.TagNumber(16)
  void clearHasClosedYears() => $_clearField(16);
}
...
class UserManagementRights extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UserManagementRights clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
