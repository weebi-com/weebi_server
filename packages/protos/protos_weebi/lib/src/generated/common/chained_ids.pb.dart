...
class ChainIdAndboutiqueId extends $pb.GeneratedMessage {
  ...
  ChainIdAndboutiqueId clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class BoutiqueIndexAndDeviceIndex extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'weebi.common.chained_ids'),
      createEmptyInstance: create)
    ..aI(1, _omitFieldNames ? '' : 'boutiqueIndex', protoName: 'boutiqueIndex')
    ..aI(2, _omitFieldNames ? '' : 'deviceIndex', protoName: 'deviceIndex')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BoutiqueIndexAndDeviceIndex clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
