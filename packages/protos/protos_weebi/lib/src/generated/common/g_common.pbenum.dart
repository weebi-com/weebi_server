...
class StatusResponse_Type extends $pb.ProtobufEnum {
  static const StatusResponse_Type SUCCESS =
      StatusResponse_Type._(0, _omitEnumNames ? '' : 'SUCCESS');
  static const StatusResponse_Type ERROR =
      StatusResponse_Type._(1, _omitEnumNames ? '' : 'ERROR');
  static const StatusResponse_Type CREATED =
      StatusResponse_Type._(2, _omitEnumNames ? '' : 'CREATED');
  static const StatusResponse_Type UPDATED =
      StatusResponse_Type._(3, _omitEnumNames ? '' : 'UPDATED');
  static const StatusResponse_Type DELETED =
      StatusResponse_Type._(4, _omitEnumNames ? '' : 'DELETED');
  ...
  static final $core.List<StatusResponse_Type?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 4);
  static StatusResponse_Type? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const StatusResponse_Type._(super.value, super.name);
}
