...
import 'g_timestamp.pb.dart' as $19;
...
class StatusResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.retail.common'), createEmptyInstance: create)
    ..aOM<$19.Timestamp>(1, _omitFieldNames ? '' : 'timestamp', subBuilder: $19.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $19.Timestamp get timestamp => $_getN(0);
  @$pb.TagNumber(1)
  set timestamp($19.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTimestamp() => $_has(0);
  @$pb.TagNumber(1)
  void clearTimestamp() => clearField(1);
  @$pb.TagNumber(1)
  $19.Timestamp ensureTimestamp() => $_ensure(0);
