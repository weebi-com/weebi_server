...
class FenceServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$1.Tokens> exchangeWebBridgeToken(
    $1.ExchangeWebBridgeTokenRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$exchangeWebBridgeToken, request,
        options: options);
  }
  ...
  static final _$logout = $grpc.ClientMethod<$0.Empty, $0.Empty>(
      ...
      ($0.Empty value) => value.writeToBuffer(),
      $0.Empty.fromBuffer);
  static final _$getSessionInternal =
      $grpc.ClientMethod<$1.SessionRequest, $1.Tokens>(
          '/weebi.fence.service.FenceService/getSessionInternal',
          ($1.SessionRequest value) => value.writeToBuffer(),
          $1.Tokens.fromBuffer);
  ...
  static final _$confirmPasswordReset =
      $grpc.ClientMethod<$1.PasswordResetConfirmRequest, $3.StatusResponse>(
          ...
          $3.StatusResponse.fromBuffer);
  static final _$createWebBridgeLink = $grpc.ClientMethod<
          $1.CreateWebBridgeLinkRequest, $1.CreateWebBridgeLinkResponse>(
      '/weebi.fence.service.FenceService/createWebBridgeLink',
      ($1.CreateWebBridgeLinkRequest value) => value.writeToBuffer(),
      $1.CreateWebBridgeLinkResponse.fromBuffer);
  static final _$exchangeWebBridgeToken =
      $grpc.ClientMethod<$1.ExchangeWebBridgeTokenRequest, $1.Tokens>(
          '/weebi.fence.service.FenceService/exchangeWebBridgeToken',
          ($1.ExchangeWebBridgeTokenRequest value) => value.writeToBuffer(),
          $1.Tokens.fromBuffer);
  ...
  static final _$deleteOneChain =
      $grpc.ClientMethod<$1.DeleteChainRequest, $3.StatusResponse>(
          '/weebi.fence.service.FenceService/deleteOneChain',
          ($1.DeleteChainRequest value) => value.writeToBuffer(),
          $3.StatusResponse.fromBuffer);
...
abstract class FenceServiceBase extends $grpc.Service {
  ...
  FenceServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.Empty, $0.Empty>(
        ...
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.SessionRequest, $1.Tokens>(
        'getSessionInternal',
        getSessionInternal_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.SessionRequest.fromBuffer(value),
        ($1.Tokens value) => value.writeToBuffer()));
    ...
    $addMethod(
        $grpc.ServiceMethod<$1.PasswordResetConfirmRequest, $3.StatusResponse>(
            ...
            ($3.StatusResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CreateWebBridgeLinkRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.CreateWebBridgeLinkRequest.fromBuffer(value),
        ($1.CreateWebBridgeLinkResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.ExchangeWebBridgeTokenRequest, $1.Tokens>(
        'exchangeWebBridgeToken',
        exchangeWebBridgeToken_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $1.ExchangeWebBridgeTokenRequest.fromBuffer(value),
        ($1.Tokens value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$1.ChainRequest, $3.StatusResponse>(
        ...
        ($3.StatusResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.DeleteChainRequest, $3.StatusResponse>(
        'deleteOneChain',
        deleteOneChain_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $1.DeleteChainRequest.fromBuffer(value),
        ($3.StatusResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$1.CreateWebBridgeLinkResponse> createWebBridgeLink_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$1.CreateWebBridgeLinkRequest> $request) async {
    return createWebBridgeLink($call, await $request);
  }

  $async.Future<$1.CreateWebBridgeLinkResponse> createWebBridgeLink(
      $grpc.ServiceCall call, $1.CreateWebBridgeLinkRequest request);

  $async.Future<$1.Tokens> exchangeWebBridgeToken_Pre($grpc.ServiceCall $call,
      $async.Future<$1.ExchangeWebBridgeTokenRequest> $request) async {
    return exchangeWebBridgeToken($call, await $request);
  }

  $async.Future<$1.Tokens> exchangeWebBridgeToken(
      $grpc.ServiceCall call, $1.ExchangeWebBridgeTokenRequest request);
  ...
  $async.Future<$3.StatusResponse> deleteOneChain_Pre($grpc.ServiceCall $call,
      $async.Future<$1.DeleteChainRequest> $request) async {
    return deleteOneChain($call, await $request);
  }

  $async.Future<$3.StatusResponse> deleteOneChain(
      $grpc.ServiceCall call, $1.DeleteChainRequest request);
