...
class AppMinVersionRequest extends $pb.GeneratedMessage {
  ...
  AppMinVersionRequest clone() =>
      AppMinVersionRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<AppMinVersionRequest> createRepeated() =>
      $pb.PbList<AppMinVersionRequest>();
  @$core.pragma('dart2js:noInline')
...
class AppMinVersionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'weebi.weebi_app.service'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'minVersion', $pb.PbFieldType.O3,
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AppMinVersionResponse clone() =>
      AppMinVersionResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<AppMinVersionResponse> createRepeated() =>
      $pb.PbList<AppMinVersionResponse>();
  @$core.pragma('dart2js:noInline')
