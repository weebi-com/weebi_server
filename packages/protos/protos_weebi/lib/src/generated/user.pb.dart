...
class UserPublic extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserPublic', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.user'), createEmptyInstance: create)
    ...
    ..aOM<$25.UserPermissions>(7, _omitFieldNames ? '' : 'permissions', subBuilder: $25.UserPermissions.create)
  ...
  @$pb.TagNumber(7)
  $25.UserPermissions get permissions => $_getN(6);
  @$pb.TagNumber(7)
  set permissions($25.UserPermissions v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasPermissions() => $_has(6);
  @$pb.TagNumber(7)
  void clearPermissions() => clearField(7);
  @$pb.TagNumber(7)
  $25.UserPermissions ensurePermissions() => $_ensure(6);
...
class UserPrivate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserPrivate', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.user'), createEmptyInstance: create)
    ...
    ..aOM<$25.UserPermissions>(8, _omitFieldNames ? '' : 'permissions', subBuilder: $25.UserPermissions.create)
    ...
    ..aOM<$20.Timestamp>(12, _omitFieldNames ? '' : 'creationDateUTC', protoName: 'creationDateUTC', subBuilder: $20.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $25.UserPermissions get permissions => $_getN(7);
  @$pb.TagNumber(8)
  set permissions($25.UserPermissions v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasPermissions() => $_has(7);
  @$pb.TagNumber(8)
  void clearPermissions() => clearField(8);
  @$pb.TagNumber(8)
  $25.UserPermissions ensurePermissions() => $_ensure(7);
  ...
  @$pb.TagNumber(12)
  $20.Timestamp get creationDateUTC => $_getN(11);
  @$pb.TagNumber(12)
  set creationDateUTC($20.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasCreationDateUTC() => $_has(11);
  @$pb.TagNumber(12)
  void clearCreationDateUTC() => clearField(12);
  @$pb.TagNumber(12)
  $20.Timestamp ensureCreationDateUTC() => $_ensure(11);
...
class PendingUserRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PendingUserRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.user'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'firstname')
    ..aOS(3, _omitFieldNames ? '' : 'lastname')
    ..aOM<$25.UserPermissions>(4, _omitFieldNames ? '' : 'permissions', subBuilder: $25.UserPermissions.create)
    ..aOM<$21.Phone>(5, _omitFieldNames ? '' : 'phone', subBuilder: $21.Phone.create)
  ...
  @$pb.TagNumber(4)
  $25.UserPermissions get permissions => $_getN(3);
  @$pb.TagNumber(4)
  set permissions($25.UserPermissions v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPermissions() => $_has(3);
  @$pb.TagNumber(4)
  void clearPermissions() => clearField(4);
  @$pb.TagNumber(4)
  $25.UserPermissions ensurePermissions() => $_ensure(3);
