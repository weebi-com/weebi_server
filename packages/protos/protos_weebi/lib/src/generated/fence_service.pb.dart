...
import 'user_permissions.pb.dart' as $25;
...
class ChainRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $23.BusinessRules get businessRules => $_getN(5);
  @$pb.TagNumber(6)
  set businessRules($23.BusinessRules v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class BoutiqueRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BoutiqueRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'chainId', protoName: 'chainId')
    ..aOM<$23.BoutiquePb>(2, _omitFieldNames ? '' : 'boutique', subBuilder: $23.BoutiquePb.create)
  ...
  @$pb.TagNumber(2)
  $23.BoutiquePb get boutique => $_getN(1);
  @$pb.TagNumber(2)
  set boutique($23.BoutiquePb v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBoutique() => $_has(1);
  @$pb.TagNumber(2)
  void clearBoutique() => clearField(2);
  @$pb.TagNumber(2)
  $23.BoutiquePb ensureBoutique() => $_ensure(1);
...
class BoutiqueResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BoutiqueResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..aOM<$23.BoutiquePb>(1, _omitFieldNames ? '' : 'boutique', subBuilder: $23.BoutiquePb.create)
  ...
  @$pb.TagNumber(1)
  $23.BoutiquePb get boutique => $_getN(0);
  @$pb.TagNumber(1)
  set boutique($23.BoutiquePb v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBoutique() => $_has(0);
  @$pb.TagNumber(1)
  void clearBoutique() => clearField(1);
  @$pb.TagNumber(1)
  $23.BoutiquePb ensureBoutique() => $_ensure(0);
...
class ReadOneUserResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadOneUserResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..aOM<$1.StatusResponse>(1, _omitFieldNames ? '' : 'statusResponse', protoName: 'statusResponse', subBuilder: $1.StatusResponse.create)
    ..aOM<$9.UserPublic>(2, _omitFieldNames ? '' : 'user', subBuilder: $9.UserPublic.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $9.UserPublic get user => $_getN(1);
  @$pb.TagNumber(2)
  set user($9.UserPublic v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUser() => $_has(1);
  @$pb.TagNumber(2)
  void clearUser() => clearField(2);
  @$pb.TagNumber(2)
  $9.UserPublic ensureUser() => $_ensure(1);
}

class UsersPublic extends $pb.GeneratedMessage {
  factory UsersPublic({
    $core.Iterable<$9.UserPublic>? users,
  }) {
    final result = create();
    if (users != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UsersPublic', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..pc<$9.UserPublic>(1, _omitFieldNames ? '' : 'users', $pb.PbFieldType.PM, subBuilder: $9.UserPublic.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$9.UserPublic> get users => $_getList(0);
}
...
class ReadAllBoutiquesResponse extends $pb.GeneratedMessage {
  factory ReadAllBoutiquesResponse({
    $core.Iterable<$23.BoutiquePb>? boutiques,
  }) {
    final result = create();
    if (boutiques != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadAllBoutiquesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..pc<$23.BoutiquePb>(1, _omitFieldNames ? '' : 'boutiques', $pb.PbFieldType.PM, subBuilder: $23.BoutiquePb.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$23.BoutiquePb> get boutiques => $_getList(0);
}
...
class Access extends $pb.GeneratedMessage {
  factory Access({
    $25.ChainIds? chainIds,
    $25.BoutiqueIds? boutiqueIds,
  }) {
    final result = create();
    if (chainIds != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Access', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..aOM<$25.ChainIds>(1, _omitFieldNames ? '' : 'chainIds', protoName: 'chainIds', subBuilder: $25.ChainIds.create)
    ..aOM<$25.BoutiqueIds>(2, _omitFieldNames ? '' : 'boutiqueIds', protoName: 'boutiqueIds', subBuilder: $25.BoutiqueIds.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $25.ChainIds get chainIds => $_getN(0);
  @$pb.TagNumber(1)
  set chainIds($25.ChainIds v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasChainIds() => $_has(0);
  @$pb.TagNumber(1)
  void clearChainIds() => clearField(1);
  @$pb.TagNumber(1)
  $25.ChainIds ensureChainIds() => $_ensure(0);

  @$pb.TagNumber(2)
  $25.BoutiqueIds get boutiqueIds => $_getN(1);
  @$pb.TagNumber(2)
  set boutiqueIds($25.BoutiqueIds v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBoutiqueIds() => $_has(1);
  @$pb.TagNumber(2)
  void clearBoutiqueIds() => clearField(2);
  @$pb.TagNumber(2)
  $25.BoutiqueIds ensureBoutiqueIds() => $_ensure(1);
}
...
class PasswordUpdateRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  void clearPasswordCurrent() => clearField(3);
  ...
  @$pb.TagNumber(4)
  void clearPasswordNew() => clearField(4);
}
...
class CodeForPairingDevice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CodeForPairingDevice', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ...
    ..aOM<$20.Timestamp>(6, _omitFieldNames ? '' : 'timestampUTC', protoName: 'timestampUTC', subBuilder: $20.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $20.Timestamp get timestampUTC => $_getN(5);
  @$pb.TagNumber(6)
  set timestampUTC($20.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTimestampUTC() => $_has(5);
  @$pb.TagNumber(6)
  void clearTimestampUTC() => clearField(6);
  @$pb.TagNumber(6)
  $20.Timestamp ensureTimestampUTC() => $_ensure(5);
}
...
class PasswordResetConfirmRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearResetToken() => clearField(2);
...
class MarkEmailVerifiedRequest extends $pb.GeneratedMessage {
  ...
  MarkEmailVerifiedRequest._() : super();
  factory MarkEmailVerifiedRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MarkEmailVerifiedRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MarkEmailVerifiedRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'mail')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  MarkEmailVerifiedRequest clone() => MarkEmailVerifiedRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MarkEmailVerifiedRequest copyWith(void Function(MarkEmailVerifiedRequest) updates) => super.copyWith((message) => updates(message as MarkEmailVerifiedRequest)) as MarkEmailVerifiedRequest;
  ...
  static $pb.PbList<MarkEmailVerifiedRequest> createRepeated() => $pb.PbList<MarkEmailVerifiedRequest>();
  @$core.pragma('dart2js:noInline')
  static MarkEmailVerifiedRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MarkEmailVerifiedRequest>(create);
...
class UpdateSubscriberIdRequest extends $pb.GeneratedMessage {
  ...
  UpdateSubscriberIdRequest._() : super();
  factory UpdateSubscriberIdRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateSubscriberIdRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateSubscriberIdRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'mail')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateSubscriberIdRequest clone() => UpdateSubscriberIdRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateSubscriberIdRequest copyWith(void Function(UpdateSubscriberIdRequest) updates) => super.copyWith((message) => updates(message as UpdateSubscriberIdRequest)) as UpdateSubscriberIdRequest;
  ...
  static $pb.PbList<UpdateSubscriberIdRequest> createRepeated() => $pb.PbList<UpdateSubscriberIdRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateSubscriberIdRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateSubscriberIdRequest>(create);
...
class HealthCheckWeebiResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set versions(ServiceVersions v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  void clearDatabaseHealthy() => clearField(4);
}
...
class ServiceVersions extends $pb.GeneratedMessage {
  factory ServiceVersions({
    ...
    if (protosWeebi != null) {
      result.protosWeebi = protosWeebi;
    }
    if (fenceService != null) {
      result.fenceService = fenceService;
    }
    if (modelsWeebi != null) {
  ...
  @$pb.TagNumber(2)
  set protosWeebi($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasProtosWeebi() => $_has(1);
  @$pb.TagNumber(2)
  void clearProtosWeebi() => clearField(2);

  @$pb.TagNumber(3)
  $core.String get fenceService => $_getSZ(2);
  @$pb.TagNumber(3)
  set fenceService($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasFenceService() => $_has(2);
  @$pb.TagNumber(3)
  void clearFenceService() => clearField(3);

  @$pb.TagNumber(4)
  $core.String get modelsWeebi => $_getSZ(3);
  @$pb.TagNumber(4)
  set modelsWeebi($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasModelsWeebi() => $_has(3);
  @$pb.TagNumber(4)
  void clearModelsWeebi() => clearField(4);
}
