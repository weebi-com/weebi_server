...
class ChainRequest extends $pb.GeneratedMessage {
  factory ChainRequest({
    ...
    $8.BusinessRules? businessRules,
    $core.String? commercialRegisterNumber,
    $8.CommerceTypePb? commerceType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(4, _omitFieldNames ? '' : 'isDualCurrencyEnabled',
        protoName: 'isDualCurrencyEnabled')
    ..aOS(5, _omitFieldNames ? '' : 'secondaryDisplayCurrency',
        protoName: 'secondaryDisplayCurrency')
    ..aOM<$8.BusinessRules>(6, _omitFieldNames ? '' : 'businessRules',
        protoName: 'businessRules', subBuilder: $8.BusinessRules.create)
    ..aOS(7, _omitFieldNames ? '' : 'commercialRegisterNumber')
    ..aE<$8.CommerceTypePb>(8, _omitFieldNames ? '' : 'commerceType',
        enumValues: $8.CommerceTypePb.values)
    ..aOS(9, _omitFieldNames ? '' : 'isicCode')
    ..aOS(10, _omitFieldNames ? '' : 'isicSubCode')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ChainRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(4)
  set isDualCurrencyEnabled($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(4)
  $core.bool hasIsDualCurrencyEnabled() => $_has(3);
  @$pb.TagNumber(4)
  void clearIsDualCurrencyEnabled() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.String get secondaryDisplayCurrency => $_getSZ(4);
  @$pb.TagNumber(5)
  set secondaryDisplayCurrency($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasSecondaryDisplayCurrency() => $_has(4);
  @$pb.TagNumber(5)
  void clearSecondaryDisplayCurrency() => $_clearField(5);

  @$pb.TagNumber(6)
  $8.BusinessRules get businessRules => $_getN(5);
  @$pb.TagNumber(6)
  set businessRules($8.BusinessRules value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasBusinessRules() => $_has(5);
  @$pb.TagNumber(6)
  void clearBusinessRules() => $_clearField(6);
  @$pb.TagNumber(6)
  $8.BusinessRules ensureBusinessRules() => $_ensure(5);

  @$pb.TagNumber(7)
  $core.String get commercialRegisterNumber => $_getSZ(6);
  @$pb.TagNumber(7)
  set commercialRegisterNumber($core.String value) => $_setString(6, value);
  @$pb.TagNumber(7)
  $core.bool hasCommercialRegisterNumber() => $_has(6);
  @$pb.TagNumber(7)
  void clearCommercialRegisterNumber() => $_clearField(7);

  @$pb.TagNumber(8)
  $8.CommerceTypePb get commerceType => $_getN(7);
  @$pb.TagNumber(8)
  set commerceType($8.CommerceTypePb value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasCommerceType() => $_has(7);
  @$pb.TagNumber(8)
  void clearCommerceType() => $_clearField(8);

  @$pb.TagNumber(9)
  $core.String get isicCode => $_getSZ(8);
  @$pb.TagNumber(9)
  set isicCode($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
  $core.bool hasIsicCode() => $_has(8);
  @$pb.TagNumber(9)
  void clearIsicCode() => $_clearField(9);

  @$pb.TagNumber(10)
  $core.String get isicSubCode => $_getSZ(9);
  @$pb.TagNumber(10)
  set isicSubCode($core.String value) => $_setString(9, value);
  @$pb.TagNumber(10)
  $core.bool hasIsicSubCode() => $_has(9);
  @$pb.TagNumber(10)
  void clearIsicSubCode() => $_clearField(10);
}
...
class DeleteChainRequest extends $pb.GeneratedMessage {
  ...
  DeleteChainRequest._();

  factory DeleteChainRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DeleteChainRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DeleteChainRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'chainId', protoName: 'chainId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeleteChainRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeleteChainRequest copyWith(void Function(DeleteChainRequest) updates) =>
      super.copyWith((message) => updates(message as DeleteChainRequest))
          as DeleteChainRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static DeleteChainRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DeleteChainRequest>(create);
...
class BoutiqueRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BoutiqueRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class BoutiqueResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BoutiqueResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReadOneUserResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReadOneUserResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class UsersPublic extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'),
      createEmptyInstance: create)
    ..pPM<$2.UserPublic>(1, _omitFieldNames ? '' : 'users',
        subBuilder: $2.UserPublic.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UsersPublic clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReadAllChainsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'),
      createEmptyInstance: create)
    ..pPM<$5.Chain>(1, _omitFieldNames ? '' : 'chains',
        subBuilder: $5.Chain.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReadAllChainsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReadAllBoutiquesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'),
      createEmptyInstance: create)
    ..pPM<$8.BoutiquePb>(1, _omitFieldNames ? '' : 'boutiques',
        subBuilder: $8.BoutiquePb.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReadAllBoutiquesResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReadDevicesRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReadDevicesRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class IsADeviceInChainResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IsADeviceInChainResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReadDeviceBtqRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReadDeviceBtqRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class MailAndEncyptedPassword extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MailAndEncyptedPassword clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class Credentials extends $pb.GeneratedMessage {
  factory Credentials({
    ...
    if (isWebApp != null) result.isWebApp = isWebApp;
    return result;
  }
  ...
  @$pb.TagNumber(3)
  set isWebApp($core.bool value) => $_setBool(2, value);
  @$pb.TagNumber(3)
  $core.bool hasIsWebApp() => $_has(2);
  @$pb.TagNumber(3)
  void clearIsWebApp() => $_clearField(3);
}
...
class DeviceCredentials extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeviceCredentials clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class RefreshToken extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set isWebApp($core.bool value) => $_setBool(1, value);
  @$pb.TagNumber(2)
  $core.bool hasIsWebApp() => $_has(1);
  @$pb.TagNumber(2)
  void clearIsWebApp() => $_clearField(2);
}
...
class CreateWebBridgeLinkRequest extends $pb.GeneratedMessage {
  factory CreateWebBridgeLinkRequest({
    ...
    if (returnDeepLink != null) result.returnDeepLink = returnDeepLink;
    return result;
  }

  CreateWebBridgeLinkRequest._();

  factory CreateWebBridgeLinkRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CreateWebBridgeLinkRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CreateWebBridgeLinkRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'productId', protoName: 'productId')
    ..aI(2, _omitFieldNames ? '' : 'fiscalYear', protoName: 'fiscalYear')
    ..aOS(3, _omitFieldNames ? '' : 'returnDeepLink',
        protoName: 'returnDeepLink')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateWebBridgeLinkRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateWebBridgeLinkRequest copyWith(
          void Function(CreateWebBridgeLinkRequest) updates) =>
      super.copyWith(
              (message) => updates(message as CreateWebBridgeLinkRequest))
          as CreateWebBridgeLinkRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static CreateWebBridgeLinkRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CreateWebBridgeLinkRequest>(create);
...
class CreateWebBridgeLinkResponse extends $pb.GeneratedMessage {
  ...
  CreateWebBridgeLinkResponse._();

  factory CreateWebBridgeLinkResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CreateWebBridgeLinkResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CreateWebBridgeLinkResponse',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'),
      createEmptyInstance: create)
    ...
    ..aInt64(3, _omitFieldNames ? '' : 'expiresAtUnix',
        protoName: 'expiresAtUnix')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateWebBridgeLinkResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateWebBridgeLinkResponse copyWith(
          void Function(CreateWebBridgeLinkResponse) updates) =>
      super.copyWith(
              (message) => updates(message as CreateWebBridgeLinkResponse))
          as CreateWebBridgeLinkResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CreateWebBridgeLinkResponse create() =>
      CreateWebBridgeLinkResponse._();
  @$core.override
  CreateWebBridgeLinkResponse createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static CreateWebBridgeLinkResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CreateWebBridgeLinkResponse>(create);
...
class ExchangeWebBridgeTokenRequest extends $pb.GeneratedMessage {
  ...
  ExchangeWebBridgeTokenRequest._();

  factory ExchangeWebBridgeTokenRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ExchangeWebBridgeTokenRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ExchangeWebBridgeTokenRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'weebi.fence.service'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ExchangeWebBridgeTokenRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ExchangeWebBridgeTokenRequest copyWith(
          void Function(ExchangeWebBridgeTokenRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ExchangeWebBridgeTokenRequest))
          as ExchangeWebBridgeTokenRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ExchangeWebBridgeTokenRequest create() =>
      ExchangeWebBridgeTokenRequest._();
  @$core.override
  ExchangeWebBridgeTokenRequest createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ExchangeWebBridgeTokenRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ExchangeWebBridgeTokenRequest>(create);
...
class UpdateDevicePasswordRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UpdateDevicePasswordRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class PasswordUpdateRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PasswordUpdateRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class PendingDeviceRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PendingDeviceRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class CodeForPairingDevice extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CodeForPairingDevice clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ApproveDeviceRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ApproveDeviceRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class PasswordResetConfirmRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PasswordResetConfirmRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class MarkEmailVerifiedRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MarkEmailVerifiedRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class HealthCheckWeebiResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  HealthCheckWeebiResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ServiceVersions extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ServiceVersions clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
