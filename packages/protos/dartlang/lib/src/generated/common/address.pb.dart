...
class Address extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Address', package: const $pb.PackageName(_omitMessageNames ? '' : 'weebi.common.address'), createEmptyInstance: create)
    ...
    ..aOM<$15.Country>(4, _omitFieldNames ? '' : 'country', subBuilder: $15.Country.create)
  ...
  @$pb.TagNumber(4)
  $15.Country get country => $_getN(3);
  @$pb.TagNumber(4)
  set country($15.Country v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCountry() => $_has(3);
  @$pb.TagNumber(4)
  void clearCountry() => clearField(4);
  @$pb.TagNumber(4)
  $15.Country ensureCountry() => $_ensure(3);
