...
const Access$json = {
  '1': 'Access',
  '2': [
    {'1': 'chainsAccessible', '3': 1, '4': 1, '5': 11, '6': '.weebi.user.Ids', '10': 'chainsAccessible'},
    {'1': 'boutiquesAccessible', '3': 2, '4': 1, '5': 11, '6': '.weebi.user.Ids', '10': 'boutiquesAccessible'},
  ],
};
...
final $typed_data.Uint8List accessDescriptor = $convert.base64Decode(
    'CgZBY2Nlc3MSOwoQY2hhaW5zQWNjZXNzaWJsZRgBIAEoCzIPLndlZWJpLnVzZXIuSWRzUhBjaG'
    'FpbnNBY2Nlc3NpYmxlEkEKE2JvdXRpcXVlc0FjY2Vzc2libGUYAiABKAsyDy53ZWViaS51c2Vy'
    'Lklkc1ITYm91dGlxdWVzQWNjZXNzaWJsZQ==');
...
final $typed_data.Uint8List createOneRequestDescriptor = $convert.base64Decode(
    'ChBDcmVhdGVPbmVSZXF1ZXN0EjAKCHVzZXJJbmZvGAEgASgLMhQud2VlYmkudXNlci5Vc2VySW'
    '5mb1IIdXNlckluZm8SGgoIcGFzc3dvcmQYAiABKAlSCHBhc3N3b3JkEiAKC2lzRmlyc3RVc2Vy'
    'GAMgASgIUgtpc0ZpcnN0VXNlcg==');
